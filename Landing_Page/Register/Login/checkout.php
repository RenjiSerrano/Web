...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `orders`(name, phone_number, method, province, city, barangay, street, total_products, total_price) VALUES('$name','$phone_number','$method','$province','$city','$barangay','$street','$total_product','$price_total')") or die('query failed');
